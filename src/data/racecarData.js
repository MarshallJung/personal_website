...
export const racecarVideos = [
  ...
  {
    id: "rocker-suspension",
    title: "Rear Rocker Arm Kinematics · Road Shakedown",
    kicker: "[ 02 / YOUTUBE SHORT · 9:16 ]",
    format: "YouTube Short",
    orientation: "vertical",
    aspectRatio: "9/16",
    url: "https://youtube.com/shorts/6fdsDh3_quw?si=B9Pt0d1_VKTsXCcK",
    youtubeId: "6fdsDh3_quw",
    thumbnail: "/images/racecar/video_rocker_crop.jpg",
    fallbackThumbnail: "https://img.youtube.com/vi/6fdsDh3_quw/maxresdefault.jpg",
    location: "Road Shakedown & Dynamics",
    badge: "Kinematics & Suspension",
    tag: "PUSHROD & ROCKER DYNAMICS",
    description: "Here is a short video of the rear rocker arm suspension during a road shakedown.",
    techNote: "Kinematics: 2:1 motion ratio rocker geometry actuating Koni single-adjustable dampers under dynamic road compression.",
    metrics: [
      { label: "Geometry", value: "Pushrod & Rocker" },
      { label: "Ratio", value: "2:1 Motion Ratio" },
      { label: "Aspect", value: "9:16 Vertical Short" },
    ],
  },
  {
